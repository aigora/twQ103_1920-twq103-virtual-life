...
void InicioSesion(char usuarioInicio[], int *nusuario,struct usuario datos[]);
void CrearUsuario(char usuarioInicio[], int *nusuario,struct usuario datos[]);
void Instrucciones(char*info);
int CargarRanking(struct final resultados[], int *nfinal);
void Ranking(char usuarioInicio[],int *puntosMuerte, int *nfinal,struct final resultados[]);
void bannerRanking();
	...
	do{
		...
		if(opcion=='a' || opcion=='b'){
			...
			do{
				...
				printf("Este es tu primer dia de clase:\n");
				printf("a-No lloro ya soy mayor, me pongo a jugar con otros ni%cos\nb-Entro timidamente,me pongo a jugar solo pero luego me uno a los demas\nc-Me tiro al suelo, me pongo a llorar y me agarro al pie de mi madre. NO QUIEROOO\n",164);
				fflush(stdin);
				scanf("%c",&decision);
			...
			do{
				printf("----------------------------------------------\n");
				printf("ha pasado mucho tiempo y el perro de la familia a muerto:\n");
				...
				if(puntosVida%2==0){
					printf("Vaya tu amigo no esta en la misma clase, mala suerte pero os veis en los recreos\n");
					puntosVida+=1;
				}else{
			...
			do{
				...
				if(decision=='a'&& puntosVida>=20){
					printf("Es lo mas sensato, bien hecho\n");
				}else if(decision=='b' && puntosVida>=29){
					printf("Vaya has llegado por los pelos, ten mas cuidado a la proxima!\n");
			...
			do{
				printf("----------------------------------------------\n");
				printf("Por fin ha llegado el dia, hoy comienzas el instituto! \nTienes miedo de que te separen de tus amigos porque os juntais con gente nueva.\n");
				printf(" Como te relacionas con el resto?:\n");
				printf("a-me quedo en mi mesa, no soy muy social.\nb-Aunque me cueste un poco hablo con casi todo el mundo, hay que ir conociendo a la gente\nc-Desde el día 1 soy popular en clase, todos me conocen.\n");
				fflush(stdin);
				scanf("%c",&decision);
			...
			do{
				printf("----------------------------------------------\n");
				printf("Los estudios se empiezan a poner serios y va siendo hora de \nponerse un poco serio para poder elegir una carrera:\n");
				printf("Como llevas el tema de estudiar?\n");
				printf("a-eso de estudiar a mi no me gusta nada, si hace falta me pongo a currar pronto\nb-estudio y me esfuerzo, pero no me mato por sacar las mejores notas\nc-Me esfuerzo mucho por sacar las mejores notas posibles, quiero acceder a una buena carrera.\n");
				fflush(stdin);
				scanf("%c",&decision);
			...
			do{
				printf("----------------------------------------------\n");
				printf("\n");
				printf("Acabas de terminar 2 de Bachiller, no sabes ni como ha pasado \ntan rapido, pero ahora toca pasar el mejor verano de tu vida\n");
				printf("En que inviertes tu tiempo?\n");
				printf("a-Me voy de viaje con mis amigos y me paso el verano de fiesta en fiesta, hay que celebrarlo!\nb-viajo con mis amigos y salgo a alguna fiesta, pero tambien disfruto de la tranquilidad del verano\nc-No me gusta el verano, asi que me lo paso en casa.\n");
				fflush(stdin);
				scanf("%c",&decision);
			...
			do{
				printf("----------DECISION IMPORTANTE----------\n");
				printf("\n");
				printf("Tras muchos esfuerzos y sudores has conseguido \nacabar la universidad. Ahora toca empezar una nueva etapa\n");
				printf("Que haces?\n");
				...
				printf("b-Me tomo un a%co sabatico, recorrere el mundo y conocere infinitos lugares nuevos\n",164);
				...
				if(decision=='a'){
					if(puntosVida<90){
						printf("Sorprendentemente la empresa iba mejor de lo esperado, pero \nun dia se produce un atraco en la tienda y tu estabas presente.\n");
					...
					return 0;
						...
						printf("La empresa se estaba arrastrando economicamente, hasta que por motivos que \nnadie conoce se hizo popular en instagram customizar tus gomas de pelo\n");
					}
				}else if(decision=='b'){
					if(puntosVida<130){
					printf("Dia 168: Hoy toca dia de viaje, acabo de llegar al aeropuerto y en un rato sale el avion\n");
					printf("Esa fue la ultima entrada de tu diario de viaje, alguien coloco una \nbomba en el aeropuerto y hubo 50 muertos, entre los cueles estas tu.\n");
					puntosMuerte=puntosVida;
					...
					return 0;
						...
						printf("El viaje fue muy divertido y conociste muchas culturas nuevas. \nAhora eres una persona nueva, pero toca empezar a buscar un trabajo\n");
					}
				}else if(decision=='c'){
					if(puntosVida<35){
					printf("De camino a ir a echar mas curriculums fuiste victima de un accidente automovilistico. \nNo sobrevives.\n");
					puntosMuerte=puntosVida;
			...
			do{
				...
				printf("a-Mi superior es una persona estupida, pero afortunadamente me \nvan a ascender dentro de poco y no tendre que soportarle mas.\n");
				printf("b-En seguida hago migas con mis compa%ceros y con todo el \nmundo en general, estoy feliz en este puesto.\n",164);
				printf("c-No puedo esperar a cambiar de trabajo, estoy pensando en \ncomprar una pequeña empresa con el dinero de una herencia familiar.\n");
				fflush(stdin);
				scanf("%c",&decision);
			...
			//18
				printf("----------------------------------------------\n");
				printf("\n");
				printf("Tus %cqueridos compa%ceros de trabajo” te han organizado una cita a ciegas\n",34,164);
				printf("alegando que llevas demasiado tiempo sin pareja porque ninguna de tus relaciones \n");
				printf("pasadas llegaron a ningun lado. Han reservado una cena en un restaurante, incluso \n");
				...
				if(longitudUsuario%2==0){
					printf("La cita fue un completo desastre, la otra persona era insoportable y acabo\n");
					printf("escupiendote el vino en la cara cuando le comentaste que no te lo estabas pasando \n");
					printf("bien. De camino a casa te paraste en un bar para ahogar las penas y no paso nada.\n");
					printf("Pero dos dias despues mientras estabas en la fruteria esperando a tu turno te \n");
					printf("reencuentras con tu crush del instituto y salta la chispa\n");
					puntosVida+=1;
				}else{
					printf("-Al final la otra persona resulto ser muy amable y salto la chispa. Ahora estais\n");
					printf("comenzando una relacion.");
					puntosVida+=10;
				}
				system("PAUSE");
			do{
			...
			do{
				...
				printf("----------------------------------------------\n");
				printf("\n");
				printf("Tu relacion progresa correctamente, y ha llegado el momento. \n");
				...
				if(decision=='a'){
					...
					printf("Esta bien, pero recuerda que 3 son multitud\n");
					puntosVida+=10;
				}else if(decision=='c'){
					printf("No hay prisa, todavia hay tiempo\n");
					puntosVida+=1;
				}else{
					printf("Has introducido mal la opcion. Solo vale a,b o c\n");
				}
			...
			do{
				...
				printf("----------------------------------------------\n");
				printf("\n");
				printf("En tus ultimos a%cos de trabajo.Cual es tu situacion laboral actual?\n",164);
				printf("a-Estoy creando una peque%ca empresa que esta despegando\nb-Trabajo en una gran empresa, aunque mi jefe me tiene mania y no tiene pinta de que me vaya a ascender\nc-Trabajo en la empresa familiar\n",164);
				fflush(stdin);
				scanf("%c",&decision);
			...
			do{
				printf("--------------DECISION IMPORTANTE---------------------\n");
				printf("Estas llegando tarde a una cita con uno de los proveedores mas \nimportantes para la empresa y el mas exigente, sus representantes \nsiempre miran por encima del hombro con superioridad\n");
			...
			do{
				...
				printf("----------------------------------------------\n");
				printf("\n");
				printf("Se dice por ahi que va a haber un ascenso, va a haber que \nhacer una peque%ca presentacion y un examen psicologico, lo haces?\n",164);
				printf("a-Voy a ir a probar\nb-No, ya estoy muy comodo con el sueldo actual\nc-Voy al 100%, van a quedarse boquiabiertos, aunque eso requiera \nromper con mi pareja y/o familia\n");
				fflush(stdin);
				scanf("%c",&decision);
			...
			do{
				...
				if(decision=='a'&& puntosVida>=80){
					...
					printf("La policia te ha pillado, han congelado tus cuentas, has salido en la tele. \nUn grupo de jovenes cuyos padres trabajaban a tu cargo se han sentido estafados y \nte han seguido a casa. Has muerto asesinado\n");
					puntosMuerte=puntosVida;
					...
					printf("Tu familia no ha podido olvidar que los dejaste de lado y \nahora te han internado de una residencia y mueres solo\n");
					puntosMuerte=puntosVida;
			...
			do{
				...
				if(decision=='a'){
					...
					printf("Lo siente pero tiene que mirar por su bien, vas a tener que ir tu, \nel tiene ninos peque%cos que no se cuidan solos\n",164);
					puntosVida+=0;
				}else if(decision=='c'){
			...
			if(longitudUsuario%3==0){
				printf("Multitudinario, todos te quieren mucho, pero es un poco deprimente\n");
			}else{
				printf("Peque%co, solo los mas cercanos estan, te recuerdan y saben que tu deseaba una gran fiesta\n",164);
			}
			system("PAUSE");
...
void CrearUsuario(char usuarioInicio[], int *nusuario,struct usuario datos[]){
	...
	printf("Introduzca contrase%ca:(con numeros y letras)\n",164);
	fflush(stdin);
...
void InicioSesion(char usuarioInicio[], int *nusuario,struct usuario datos[]){
	...
	do{
		...
		if(igual==0){
			printf("Usuario o contrase%ca son incorrectos.\n",164);
		}else{
			printf("Usuario valido\n");
		}
			system("PAUSE");
...
void Instrucciones(char*info){
	...
	do{
		...
		if(*info=='a'){
			...
			printf("Ejemplo: sale una decision importante con dos opciones a o b.\nCada una requiere un minimo de puntos de vida para avanzar, solo que el usuario no sabe los puntos necesarios para ello, deberás guiarte por tu intuicion.\nSi no tienes los puntos suficientes moriras.Es cuestion de SUERTE\n");
		}else if(*info=='b'){
			...
			printf("\n");
			printf("Puntos de muerte: puntos que se iran acumulando segun tus decisiones y en el caso de morir entraras o no en un ranking final de los cinco mejores\n");
		}else if(*info=='c'){
			break; 
		}else{
...
void Ranking(char usuarioInicio[],int *puntosMuerte, int *nfinal,struct final resultados[]){
	...
	//Ahora guardo todo en el fichero.
